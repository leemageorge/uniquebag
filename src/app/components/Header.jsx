...
const Header = () => {
  return (
    <div className=" border-b-[0.1px] border-[#D9C8B4] py-2">
      ...
      <div className=" bg-linear-to-br from-[#DFD9AB] to-[#F1C1A9] px-4 py-2 shadow-[3px_3px_5px_3px_rgba(0,0,0,0.2)] cursor-pointer hover:shadow-md  rounded-full">
       
          <a href="tel:+919633443047" className='text-white font-bold flex items-center gap-2 '>
             <PhoneCallIcon className= "w-5 h-5 text-[#9B7057]" />
